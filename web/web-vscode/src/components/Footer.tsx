      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="mt-4 flex flex-col gap-2">
              <a href="https://github.com/xscriptor-web/vscode" className="text-sm text-white/50 hover:text-white/80 transition-colors">GitHub</a>
              <a href="https://xscriptor.io" className="text-sm text-white/50 hover:text-white/80 transition-colors">Documentation</a>
            </div>
          </div>
          <div>
            <span className="text-xs font-medium text-white/40 uppercase tracking-wider">Community</span>
            <div className="mt-4 flex flex-col gap-2">
              <a href="https://github.com/xscriptor-web/vscode/issues" className="text-sm text-white/50 hover:text-white/80 transition-colors">Issues</a>
            </div>
          </div>
          <div>
        ...
        <div className="mt-12 pt-8 border-t border-white/[0.06] flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <a href="https://github.com/xscriptor-web" className="text-white/30 hover:text-white/60 transition-colors">
